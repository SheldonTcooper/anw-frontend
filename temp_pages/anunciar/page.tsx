...
const inputCls =
  "rounded-lg px-4 py-3 text-sm text-white placeholder-gray-500 outline-none focus:ring-1 focus:ring-[#C0306A] w-full";
      ...
      {opcoes.map((op) => {
        ...
        return (
          <label
            ...
            style={{
              backgroundColor: ativo ? "#3a1550" : "#1A0A1E",
              border: `1px solid ${ativo ? "#C0306A" : "#4A1A5C"}`,
              color: ativo ? "#fff" : "#c9a8e0",
            }}
          >
            <input
              type="checkbox"
            ...
            <span
              ...
              style={{
                backgroundColor: ativo ? "#C0306A" : "transparent",
                border: `1.5px solid ${ativo ? "#C0306A" : "#4A1A5C"}`,
              }}
            >
              {ativo && (
...
export default function AnunciarPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Anúncio enviado para revisão!");
  };
    ...
    <main className="min-h-screen px-4 py-8 sm:px-8" style={{ backgroundColor: "#1A0A1E" }}>
      <div className="mx-auto max-w-3xl">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-3 gap-3 sm:grid-cols-5">
                  {fotos.map((foto, idx) => (
                    <div key={idx} className="relative overflow-hidden rounded-lg" style={{ paddingBottom: "133%" }}>
                      ...
                      {idx === 0 && (
                        <span
                          className="absolute bottom-1 left-1 rounded px-1.5 py-0.5 text-xs font-bold"
          ...
          <button
            type="submit"
            className="w-full rounded-xl py-4 text-base font-bold uppercase tracking-wide text-white transition-opacity hover:opacity-90"
